                    ...
                    <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                        ...
                        <div class="tab-content card">
                            ...
                            <div class="tab-pane fade in show active" id="login" role="tabpanel">
                                <form action="admin/production/functions/sendEmail.php" method="POST">
                                    <div class="row">
                                        <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                            ...
                            <form action="admin/production/functions/sendEmail.php" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 form-group">
                                        <input type="text" name="subject" class="form-control" id="subject" placeholder="Pick Your Subject">
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-12 form-group">
                                        <textarea class="form-control" name="message" id="comment" placeholder="Your Comment Wite Here ..."></textarea>
                                    </div>
