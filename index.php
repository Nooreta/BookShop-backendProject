...
require_once("admin/production/functions/getCategory.php");
                    ...
                    <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                        ...
                        <div class="tab-content card">
                            ...
                            <div class="tab-pane fade in show active" id="login" role="tabpanel">
                                <form action="admin/production/functions/login.php" method="post">
                                    <div class="row">
                                        <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                            ...
                            <div class="tab-pane fade" id="panel2" role="tabpanel">
                                <form action="admin/production/functions/addUser.php" method="POST" enctype="multipart/form-data" class="register">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="userImage" class="form-control" placeholder="userImage">
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-12 col-md-12 col-lg-12 d-flex justify-content-between login_option">
                                            <button type="submit" name="submit" class="btn btn-default login_btn">Register</button>
                                        </div> 
                                    </div>
                                </form>
                            </div><!--/.Panel 2-->
                    ...
                    <?php while($category=mysqli_fetch_assoc($getCategoryResult)){ ?>
                     <div class="single_item single_item_last">
                        ...
                        <div class="blog_title">
                            ...
                            <h3><a href="bookCategory.php?categoryId=<?php echo $category['categoryId']?>" title=""><?php echo $category['categoryName']?></a></h3> 
