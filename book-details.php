...
$bookId=$_GET['bookId'];
require_once("admin/production/functions/getThisBook.php");
...
<head>
    ...
    <title>eduwise2 - Education HTML5 Template</title>
                 ...
                 <div class="col-sm-12 col-md-8 col-lg-8">
                    <div class="intro_text">
                        ...
                        <div class="pages_links">
                            <a href="#" title="">Home</a>
                            <a href="#" title="">Book</a>
                            <a href="#" title="" class="active">Book Details</a>
                        </div>
                    </div>
                </div>              
            ...
            <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                <div class="courses_details">
                    <div class="single-curses-contert">
                        <h2><?php echo $thisBook['bookTitle'] ?></h2>
                        <div class="review-option">
                            <div class="teacher-info single_items single_items_shape">
                                <img src="admin/production/images/<?php $thisBook['bookImage'] ?>" alt="" class="img-fluid">
                            ...
                            <div class="teacher_fee single_items ">
                                <span>Price</span>
                                <span class="books_price"><?php echo $thisBook['bookPrice']  ?></span>
                            </div>
                        ...
                        <div class="details-img-bxo">
                            <img src="admin/production/images/<?php echo $thisBook['bookImage'] ?> " alt="" class="img-fluid">
                        </div>
                    </div>
                    <div class="courses_tab_wrapper">  
                        ...
                        <div class="tab_contents tab-content">
                            <div role="tabpanel" class="tab-pane fade in active show" id="information">
                                <h3>Books Description <span>:</span></h3>
                                <p><?php echo $thisBook['bookDescription'] ?></p>
                                <h3><?php echo $thisBook['bookDedication'] ?></h3>
                                ...
                                <h3><?php echo $thisBook['bookPublishingHouse'] ?><span>:</span></h3>
                                <p><?php echo $thisBook['bookPublishingDate'] ?></p>
                                <ul class="step_point">
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <h4 class="panel-title click">
                                                        ...
                                                        1. Welcome to the Books<span>0/5</span></a>
                                                    </h4>
                ...
                <div class="blog-right-items">
                    <div class="courses_features widget_single">
                        <div class="items-title">
                            <h3 class="title">Books Features</h3>
                        </div>
                    ...
                    <div class="recent_post_wrapper popular_courses_post widget_single">
                        <div class="items-title">
                            <h3 class="title">Our Popular Books</h3>
                        </div>
...
<section id="scroll-top" class="scroll-top">
    ...
    <!-- JavaScript -->
    <script src="/php_Book/eduwise2/js/jquery-3.2.1.min.js"></script>
    <script src="/php_Book/eduwise2/js/popper.min.js"></script>
    <script src="/php_Book/eduwise2/js/bootstrap.min.js"></script>
    <script src="/php_Book/eduwise2/js/jquery.magnific-popup.min.js"></script>     
    <script src="/php_Book/eduwise2/js/owl.carousel.min.js"></script>   
    <script src="/php_Book/eduwise2/js/slick.min.js"></script>   
    <script src="/php_Book/eduwise2/js/jquery.meanmenu.min.js"></script>    
    <script src="/php_Book/eduwise2/js/wow.min.js"></script> 
    <!-- Counter Script -->
    <script src="/php_Book/eduwise2/js/waypoints.min.js"></script>
    <script src="/php_Book/eduwise2/js/jquery.counterup.min.js"></script>
    <script src="/php_Book/eduwise2/js/custom.js"></script>   
