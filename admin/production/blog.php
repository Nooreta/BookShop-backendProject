								...
								<div class="x_content">
									...
									<form method="post" action="functions/addBlog.php" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="file" name="blogImage" id="first-name" class="form-control ">
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="blogDescription" id="first-name" required="required" class="form-control ">
											</div>
										</div>
